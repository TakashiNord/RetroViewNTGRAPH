#if !defined(AFX_NTGRAPH_H__CF55B0EC_CF41_453C_BFEB_4740927AE8B3__INCLUDED_)
#define AFX_NTGRAPH_H__CF55B0EC_CF41_453C_BFEB_4740927AE8B3__INCLUDED_
...
public:
	...
	void SetXTime(BOOL);
	double GetMinXRange();
	void SetMinXRange(double);
	double GetMaxXRange();
	void SetMaxXRange(double);
	double GetMinYRange();
	void SetMinYRange(double);
	double GetMaxYRange();
	void SetMaxYRange(double);
...
#endif // !defined(AFX_NTGRAPH_H__CF55B0EC_CF41_453C_BFEB_4740927AE8B3__INCLUDED_)
